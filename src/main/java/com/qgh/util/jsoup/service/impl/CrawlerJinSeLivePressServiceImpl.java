...
import com.qgh.util.jsoup.model.JinSePressData;
import com.qgh.util.jsoup.model.JinSePressResult;
...
@Slf4j
@Service
public class CrawlerJinSeLivePressServiceImpl extends AbstractCrawlLivePressService implements CrawlerJinSeLivePressService {
    //这个参数代表每一次请求获得多少个数据
    ...
    @Override
    public List<PageListPress> crawlPage(int pageNum) throws IOException {
